...
/**
 * Plugin Name: Strauss Lab B
 * Description: Test plugin B with prefixed psr/log 3.x dependency.
 */

require_once __DIR__ . '/vendor-prefixed/autoload.php';

add_action('admin_notices', static function (): void {
    $interface = \StraussLab\PluginB\Vendor\Psr\Log\LoggerInterface::class;

    if (!interface_exists($interface)) {
        echo '<div class="notice notice-error"><p><strong>Strauss Lab B:</strong> prefixed LoggerInterface not found.</p></div>';
    ...
    echo '<strong>Strauss Lab B:</strong> ';
